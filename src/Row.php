...
class Row
{
     ...
     * @return array
     */
    public function toArray($nullValue = null, $calculateFormulas = false, $formatData = true, $lastColumnName = null)
    {
        $cells = [];

        $i = 0;
        foreach ($this->row->getCellIterator('A', $lastColumnName) as $cell) {
